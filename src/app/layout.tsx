...
export const metadata: Metadata = {
  title: "ExhibitHub - Student Portfolio Exhibition Platform",
  description: "Showcase your academic work and creative projects. Connect with peers, educators, employers, and collaborators. Build your portfolio and discover career opportunities.",
  keywords: "student portfolio, exhibition platform, academic showcase, career opportunities, student work, creative portfolio",
  openGraph: {
    title: "ExhibitHub - Showcase Your Best Work Here",
    description: "Build your digital portfolio and connect with peers, professors, and industry professionals through our student exhibition platform.",
    siteName: "ExhibitHub",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "ExhibitHub - Student Exhibition Platform",
    description: "Showcase your best work and connect with opportunities",
  },
  robots: {
    index: true,
    follow: true,
